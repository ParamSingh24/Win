        ...
        <div className="container flex justify-between items-center">
          <div className="flex items-center gap-4">
            <Button
              ...
              className={`text-primary-foreground hover:bg-primary-light ${isLargeText ? 'bg-primary-light' : ''}`}
            ...
            <Button
              ...
              className={`text-primary-foreground hover:bg-primary-light ${isHighContrast ? 'bg-primary-light' : ''}`}
          ...
          <div className="flex items-center gap-2">
            ...
            <select 
              ...
              className="bg-transparent border border-primary-foreground/20 rounded px-2 py-1 text-sm"
        ...
        <div className="container">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`font-poppins font-bold text-primary ${isLargeText ? 'text-xl' : 'text-lg'}`}>
                  EcoSync Nexus
                </h1>
                <p className={`text-muted-foreground ${isLargeText ? 'text-sm' : 'text-xs'}`}>
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    to={item.path}
                    className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors touch-target group ${
                      isActive 
                  ...
                  >
                    <Icon className={`${isLargeText ? 'h-6 w-6' : 'h-5 w-5'} ${isActive ? 'text-primary-foreground' : ''}`} />
                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center space-x-3 p-4 rounded-lg transition-colors touch-target ${
                        isActive 
                          ? 'bg-primary text-primary-foreground' 
                          : 'hover:bg-muted'
                      } ${isLargeText ? 'text-large' : ''}`}
